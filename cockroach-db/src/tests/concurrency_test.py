"""
Distributed database concurrency test – CockroachDB edition
...
def run_test(host: str, endpoint: str, n_threads: int, product_id: int, label: str) -> None:
    logger.debug(f"\n{'='*60}")
...
def main():
    parser = argparse.ArgumentParser(description="Test de concurrence – verrous distribués (CockroachDB)")
    ...
    logger.debug("\n╔══════════════════════════════════════════════════════════╗")
    logger.debug("║   Test de concurrence – Verrous distribués (CockroachDB) ║")
    logger.debug("╚══════════════════════════════════════════════════════════╝")
